...
@implementation Apijl_doQueryJlJE
	...
	*/
	-(UpdateOne*)get:(id)delegate selecter:(SEL)select  class:(NSString*)class key:(NSString*)key {
		...
		UpdateOne *updateone=[[UpdateOne alloc] init:@"jl_doQueryJlJE" params:array  delegate:delegate selecter:select];
