...
@implementation ApiDoQueryKc
	...
	*/
	-(UpdateOne*)get:(id)delegate selecter:(SEL)select  key:(NSString*)key class:(NSString*)class {
		...
		UpdateOne *updateone=[[UpdateOne alloc] init:@"DoQueryKc" params:array  delegate:delegate selecter:select];
