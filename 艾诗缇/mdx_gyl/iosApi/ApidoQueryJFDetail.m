...
@implementation ApidoQueryJFDetail
	 ...
	 * @callback QueryJFDetailList_Builder
	*/
	-(UpdateOne*)get:(id)delegate selecter:(SEL)select  key:(NSString*)key class:(NSString*)class {
		...
		UpdateOne *updateone=[[UpdateOne alloc] init:@"doQueryJFDetail" params:array  delegate:delegate selecter:select];
