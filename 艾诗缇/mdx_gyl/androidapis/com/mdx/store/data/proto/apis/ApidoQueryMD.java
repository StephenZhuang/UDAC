...
public class ApidoQueryMD extends com.mdx.framework.server.api.ApiUpdate {
	 ...
	 * @callback com.mdx.store.data.proto.Gongying.QueryMdList
	*/
	public UpdateOne get(Context context, Object parent, String method,String key,String mclass) {
		this.setMethod(method);
		this.setContext(context);
		this.setParent(parent);
		UpdateOne update = new UpdateOne("doQueryMD", new String[][] { 
			{"key",key},
	...
	*/
	 ...
	 * @callback com.mdx.store.data.proto.Gongying.QueryMdList
	*/
	public ApidoQueryMD set(String key,String mclass) {
