...
public class ApidoQueryCKBySMM extends com.mdx.framework.server.api.ApiUpdate {
	...
	*/
	public UpdateOne get(Context context, Object parent, String method,String key,String mclass,String smcode) {
		...
		UpdateOne update = new UpdateOne("doQueryCKBySMM", new String[][] { 
			{"key",key},
	...
	*/
	 ...
	 * @callback com.mdx.store.data.proto.Gongying.QueryCKBySMMList
	*/
	public ApidoQueryCKBySMM set(String key,String mclass,String smcode) {
