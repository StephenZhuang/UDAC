...
public class ApidoQueryMonthXse extends com.mdx.framework.server.api.ApiUpdate {
	 ...
	 * @callback com.mdx.store.data.proto.Gongying.QueryMonthXse
	*/
	public UpdateOne get(Context context, Object parent, String method,String key,String mclass) {
		this.setMethod(method);
		this.setContext(context);
		this.setParent(parent);
		UpdateOne update = new UpdateOne("doQueryMonthXse", new String[][] { 
			{"key",key},
	...
	*/
	 ...
	 * @callback com.mdx.store.data.proto.Gongying.QueryMonthXse
	*/
	public ApidoQueryMonthXse set(String key,String mclass) {
