...
public class Apijl_doDeleteMyOrder extends com.mdx.framework.server.api.ApiUpdate {
	...
	*/
	public UpdateOne get(Context context, Object parent, String method,String mclass,String key,String billcode) {
		...
		UpdateOne update = new UpdateOne("jl_doDeleteMyOrder", new String[][] { 
	...
	*/
	 ...
	 * @callback com.mdx.store.data.proto.GongT.MakeJFOrder
	*/
	public Apijl_doDeleteMyOrder set(String mclass,String key,String billcode) {
	...
	*/
	 ...
	 * @callback com.mdx.store.data.proto.GongT.MakeJFOrder
	*/
	public Apijl_doDeleteMyOrder set() {
		get(null,null,null);
		return this;
	}
