...
@interface Ios7QRViewController ()

@end

@implementation Ios7QRViewController
...
//    [scanButton setTitle:@"取消" forState:UIControlStateNormal];
    [scanButton setBackgroundImage:[UIImage imageNamed:@"qrcode_close"] forState:UIControlStateNormal];
    scanButton.frame = CGRectMake(145, 420, 30, 30);
