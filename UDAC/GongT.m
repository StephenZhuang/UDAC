...
//        allprice=[JsonData getJsonString:json key:@"allprice"]; //总额
    allcount = [json objectForKey:@"allcount"];
    allprice = [json objectForKey:@"allprice"];
        appdate=[JsonData getJsonString:json key:@"appdate"]; //审批日期
    if ([appdate isEqual:[NSNull null]]) {
        appdate = @"";
    }
...
//        je=[JsonData getJsonString:json key:@"je"]; //代表总额
    je = [json objectForKey:@"je"];
//        kccount=[JsonData getJsonString:json key:@"kccount"]; //代表总数量
    kccount = [json objectForKey:@"kccount"];
}
...
//        yue=[JsonData getJsonString:json key:@"yue"]; //余额
    allje = [json objectForKey:@"allje"];
    dhje = [json objectForKey:@"dhje"];
    ffe = [json objectForKey:@"ffe"];
    yue = [json objectForKey:@"yue"];
}
